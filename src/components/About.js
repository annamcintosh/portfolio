...
export default function About() {
  ...
  return (
    <Box className={classes.box}>
      ...
      <Typography variant="h6">{aboutContent.headingText}</Typography>
